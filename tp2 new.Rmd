...
library(dplyr)
freq_high <- filter(algue, speed == "high")
freq_medium <- filter(algue, speed == "medium")
freq_low <- filter(algue,speed =="low")

mean(as.factor(algue$speed))
#hist(freq_high)
